...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppNexusAdapter = __webpack_require__(10);
	var AolAdapter = __webpack_require__(12);
	var OpenxAdapter = __webpack_require__(13);
	var CriteoAdapter = __webpack_require__(14);
	var PubmaticAdapter = __webpack_require__(15);
	var YieldbotAdapter = __webpack_require__(16);
	var IndexExchange = __webpack_require__(17);
	var Sovrn = __webpack_require__(18);
	var PulsePointAdapter = __webpack_require__(19);
	var SpringServeAdapter = __webpack_require__(20);
	var AdformAdapter = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(3);
	var bidmanager = __webpack_require__(6);
	var bidfactory = __webpack_require__(8);
...
/***/ function(module, exports) {
	...
	/**
	 * returns index of search element in array
	 * used by `utils` when Array.prototype.indexOf is unavailable (e.g. < IE9)
	 ...
	 * @returns {*}
	 */
	exports.indexOf = function(searchElement, fromIndex) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
		...
		_public.off = function (eventString, handler, id) {
			...
			if (utils.isEmpty(event) || utils.isEmpty(event.que) && utils.isEmpty(event[id])) { return; }
			if (id && (utils.isEmpty(event[id]) || utils.isEmpty(event[id].que))) { return; }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(3),
		bidfactory = __webpack_require__(8),
		bidmanager = __webpack_require__(6),
		adloader = __webpack_require__(9);
